...
const getProfileFormData = (user: Usuario | null): ProfileFormData => ({
  nombre: user?.nombre || "",
  apellido: user?.apellido || "",
  correo: user?.correo || "",
  telefono: user?.telefono || "",
  estado: (user?.estado as "activo" | "inactivo" | "pendiente") || "activo",
});
...
function Perfil(): React.JSX.Element {
  ...
  const handleSaveProfile = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      const finalUser = (responseUser as Usuario) || updatedUser;
          ...
          <div className="row g-4 align-items-stretch">
            ...
            <div className="col-lg-4">
              <div className="card border-0 shadow-sm h-100 overflow-hidden">
                {/* CABECERA: MISMO COLOR NEGRO DEL PANEL DE PERFIL */}
                <div className="p-4 text-white bg-dark shadow-sm">
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                      ...
                      <h2 className="h4 fw-bold mb-1 text-white">
                ...
                <div className="card-body p-4">
                  ...
                  <div className="d-grid gap-2">
                    {/* BOTÓN ROJO PARA EDITAR EL PERFIL */}
                    <button
            ...
            {/* COLUMNA DERECHA: PANELES GENERALES */}
            <div className="col-lg-8">
              
              {/* RECUADRO NEGRO PRINCIPAL */}
              <div className="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4 bg-dark text-white p-4 rounded-3 shadow-sm">
                <div>
                  <h1 className="fw-bold mb-1 text-white">Panel de perfil</h1>
